...
/*CREATE DATABASE IF NOT EXISTS `school_snetech` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;*/
USE `messinq`;
...
CREATE TABLE IF NOT EXISTS `gebruiker` (
  ...
  `profielfoto` varchar(255) CHARACTER SET latin1 NOT NULL,
  `emailadres` varchar(255) CHARACTER SET latin1 NOT NULL,
  `wachtwoordhash` varchar(255) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `groep` (
  `groeps_id` int(255) NOT NULL,
  `groeps_naam` varchar(255) CHARACTER SET latin1 NOT NULL,
